...
extern "C" {
    #[doc = " The number of slots in the password safe."]
...
#[doc = " Callback function for NK_set_log_function.  The first argument is"]
#[doc = " the log level (0 = Error, 1 = Warn, 2 = Info, 3 = DebugL1,"]
#[doc = " 4 = Debug, 5 = DebugL2) and the second argument is the log message."]
pub type NK_log_function = ::std::option::Option<
    unsafe extern "C" fn(arg1: ::std::os::raw::c_int, arg2: *const ::std::os::raw::c_char),
>;
extern "C" {
    #[doc = " Set a custom log function."]
    #[doc = ""]
    #[doc = " The log function is called for every log message that matches the"]
    #[doc = " log level settings (see NK_set_debug and NK_set_debug_level)."]
    pub fn NK_set_log_function(fn_: NK_log_function);
}
extern "C" {
...
extern "C" {
    ...
    #[doc = " written to the output pointer's target.  The output pointer must"]
    #[doc = " not be null."]
    #[doc = " Storage only"]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GetRandom_t {
    pub op_success: u8,
    pub size_effective: u8,
    pub data: [u8; 51usize],
}
impl Default for GetRandom_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
extern "C" {
    pub fn NK_get_random(len: u8, out: *mut GetRandom_t) -> ::std::os::raw::c_int;
}
extern "C" {
